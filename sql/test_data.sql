...
INSERT INTO esercizio ( descrizione, id_coach ) VALUES 
('Panca piana', 1),
('Squat', 1),
('Stacco', 2),
('Lat machine', 3, 2);
...
INSERT INTO programmazione ( id_esercizio, id_programma, serie, ripetizioni, carico, note, data ) VALUES 
(1,1,4,15,80,'Prova', now()),
(1,1,4,15,80,'Prova', now());
